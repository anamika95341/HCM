...
function FilesSection({ accessToken, item, C, tone, defaultTab = "photos" }) {
      ...
      <div className="fixed inset-0 z-[70] flex sm:items-center justify-center overflow-y-auto p-4">
        ...
        >
          ...
          >
            ...
            {/* Photos Tab */}
            {activeTab === "photos" && (
              <FilesSection accessToken={accessToken} item={meeting} C={C} tone={tone} defaultTab="photos" />
            )}

            {/* Videos Tab */}
            {activeTab === "videos" && (
              <FilesSection accessToken={accessToken} item={meeting} C={C} tone={tone} defaultTab="videos" />
            )}

            {/* Documents Tab */}
            {activeTab === "documents" && (
              <FilesSection accessToken={accessToken} item={meeting} C={C} tone={tone} defaultTab="documents" />
            )}
          </div>
        </div>
      </div>
