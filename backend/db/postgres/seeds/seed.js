...
async function seedData() {
  ...
  await pool.query(
    ...
    ['admin.demo', 'Admin', 35, 'female', 'Joint Secretary', 'admin@example.gov.in', sha256('234123412354'), adminAadhaar.ciphertext, adminAadhaar.iv, adminAadhaar.tag, '9876543211', adminPasswordHash]
  );
  ...
  await pool.query(
    `INSERT INTO deos
      (username, first_name, age, sex, email, phone_number, designation, password_hash)
     VALUES ($1,$2,$3,$4,$5,$6,$7,$8)
     ON CONFLICT (username) DO NOTHING`,
    ['deo.demo', 'DEO', 29, 'other', 'deo@example.gov.in', '9876543213', 'Verification Officer', deoPasswordHash]
  );
}
